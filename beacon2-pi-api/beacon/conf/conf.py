...
cors_urls = ["http://localhost:3000","https://cancer-beacon-demo.ega-archive.org", "https://beacon-network-demo2.ega-archive.org", "https://beacon.ega-archive.org", "http://localhost:8000", "http://localhost:80", "http://localhost:9009", "http://127.0.0.1:8000", "http://127.0.0.1:80", "http://127.0.0.1", "http://localhost:8090"]
